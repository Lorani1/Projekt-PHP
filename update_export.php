...
<body>
    ...
    <div>
        ...
        <input type="text" id="name" name="Cname" value="<?php echo $info['Cname']; ?>">
    </div>
    <div>
        <label for="name">Company:</label>
        <input type="text" id="name" name="country" value="<?php echo $info['country']; ?>">
    </div>
    <div>
        <label for="name">Product name:</label>
        <input type="text" id="name" name="Pname" value="<?php echo $info['Pname']; ?>">
    </div>
    <div>
        <label for="name">Country to Export:</label>
        <input type="text" id="name" name="Cexport" value="<?php echo $info['Cexport']; ?>">
    </div>
    <div>
        <label for="name">Price:</label>
        <input type="text" id="name" name="price" value="<?php echo $info['price']; ?>">
    </div>
    <div>
        <label for="name">Message:</label>
        <input type="text" id="name" name="message" value="<?php echo $info['message']; ?>">
    </div>
    <div>
    ...
    <div>
        <input type="submit" name="update_export" value="Update Export Product">
    </div>
</form>
