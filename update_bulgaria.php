...
if ($_GET['bulgaria_id']) {
    $info = $productUpdater->getProductInfo('bulgaria', $_GET['bulgaria_id']);
}

if (isset($_POST['update_product'])) {
    $productUpdater->updateProduct('bulgaria', $_POST['id'], $_POST['name'], $_POST['description'], $_FILES['image']['name']);
}
