...
if($_GET['bulgaria_id']){
    $p_id=$_GET['bulgaria_id'];
    $sql = "SELECT * FROM bulgaria WHERE id='$p_id' ";
...
if(isset($_POST['update_product'])){
    ...
    if($file){
        $sql2 = "UPDATE bulgaria SET name='$p_name',description='$p_desc',image='$dst_db' WHERE id='$p_id' ";
    }else{
        $sql2 = "UPDATE bulgaria SET name='$p_name',description='$p_desc' WHERE id='$p_id' ";
    }
