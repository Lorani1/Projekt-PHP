<?php
include 'auth.php';
include 'connect.php'; // Include the file containing the Database class
            ...
            <table border="1px">
              ...
              while ($info = $result->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <tr>
                        ...
                        <td style="padding: 20px;color:black;">
                            <?php echo " <a href='update_aboutus.php?aboutus_id={$info['id']}' class='btn btn-primary'>Update</a>";
                            ?>
                        </td>
                    </tr>
                    <?php
