...
if($_GET['kosova_id']){
    $p_id=$_GET['kosova_id'];
    $sql = "SELECT * FROM kosova WHERE id='$p_id' ";
...
if(isset($_POST['update_product'])){
    ...
    if($file){
        $sql2 = "UPDATE kosova SET name='$p_name',description='$p_desc',image='$dst_db' WHERE id='$p_id' ";
    }else{
        $sql2 = "UPDATE kosova SET name='$p_name',description='$p_desc' WHERE id='$p_id' ";
    }
