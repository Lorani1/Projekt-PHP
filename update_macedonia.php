...
if($_GET['macedonia_id']){
    $p_id=$_GET['macedonia_id'];
    $sql = "SELECT * FROM macedonia WHERE id='$p_id' ";
...
if(isset($_POST['update_product'])){
    ...
    if($file){
        $sql2 = "UPDATE macedonia SET name='$p_name',description='$p_desc',image='$dst_db' WHERE id='$p_id' ";
    }else{
        $sql2 = "UPDATE macedonia SET name='$p_name',description='$p_desc' WHERE id='$p_id' ";
    }
