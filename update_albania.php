...
if($_GET['albania_id']){
    $p_id=$_GET['albania_id'];
    $sql = "SELECT * FROM albania WHERE id='$p_id' ";
...
if(isset($_POST['update_product'])){
    ...
    if($file){
        $sql2 = "UPDATE albania SET name='$p_name',description='$p_desc',image='$dst_db' WHERE id='$p_id' ";
    }else{
        $sql2 = "UPDATE albania SET name='$p_name',description='$p_desc' WHERE id='$p_id' ";
    }
