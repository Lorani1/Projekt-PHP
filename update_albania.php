...
if ($_GET['albania_id']) {
    $info = $productUpdater->getProductInfo('albania', $_GET['albania_id']);
}

if (isset($_POST['update_product'])) {
    $productUpdater->updateProduct('albania', $_POST['id'], $_POST['name'], $_POST['description'], $_FILES['image']['name']);
}
